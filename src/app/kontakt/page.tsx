      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-100">
            ...
            {/* WhatsApp */}
            <a
              href="https://wa.me/38512916814"
              target="_blank"
              rel="noopener noreferrer"
              className="reveal delay-200 bg-white p-10 group hover:bg-[var(--green-pale)] transition-colors"
            >
              <div className="w-12 h-12 bg-[var(--green-pale)] group-hover:bg-white flex items-center justify-center mb-6 transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" width={20} height={20} className="text-[var(--green-primary)]">
              ...
              <p className="text-[10px] uppercase tracking-widest text-gray-400 mb-2">WhatsApp</p>
              <p className="text-[1.75rem] text-[var(--charcoal)] mb-1 font-light leading-tight" style={{ fontFamily: "var(--font-cormorant)" }}>
                Pišite nam
              </p>
              <p className="text-xs text-gray-400 mb-7">+385 1 2916 814</p>
              <span className="inline-flex items-center gap-1.5 text-xs text-[var(--green-primary)] font-medium uppercase tracking-wider group-hover:gap-3 transition-all">
                Otvorite WhatsApp <ArrowRight size={12} />
              </span>
            </a>
            ...
            <a
              ...
              className="reveal delay-300 bg-white p-10 group hover:bg-[var(--green-pale)] transition-colors"
            >
              <div className="w-12 h-12 bg-[var(--green-pale)] group-hover:bg-white flex items-center justify-center mb-6 transition-colors">
